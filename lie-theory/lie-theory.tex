...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \(\lie{g} = \Span\{X, Y, Z\}\) with \(\bracket{X}{Y} = Z\) and \(\bracket{X}{Z} = \bracket{Y}{Z} = 0\).
    ...
    \begin{lma}{}{}
        ...
        Then \(V \otimes W\) is made into an \((\lie{m} \oplus \lie{l})\)-module by extending the following action
        \begin{equation}
