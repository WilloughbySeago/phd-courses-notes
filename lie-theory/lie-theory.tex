...
\DeclarePairedDelimiterX{\rootPairing}[2]{(}{)}{#1, #2}
\DeclarePairedDelimiterX{\rootPairingShort}[2]{\langle}{\rangle}{#1, #2}
...
%        \end{proof}
    ...
    \begin{lma}{}{}
        ...
        \begin{proof}
            ...
            We call the roots \(\beta + r\alpha, \dotsc, \beta - s\alpha\) \define{\(\symbf{\alpha}\)-strings through \(\symbf{\beta}\)}\index{alpha-strings through beta@\(\alpha\)-strings through \(\beta\)}.
    ...
    A linear transformation \(M \colon E \to E\) is \defineindex{orthogonal} (with respect to this inner product) if \(\innerprod{Mu}{Mv} = \innerprod{u}{v}\) for all \(u, v \in E\) (i.e., \(M\) preserves the inner product).
    ...
    \begin{dfn}{Rank}{}
        The \defineindex{rank} of a root system (and the corresponding Lie algebra) is the real dimension of \(E\) which is the complex dimension of \(\csa\).
    \end{dfn}
    ...
    \begin{dfn}{Morphism of Root Systems}{}
        ...
        A \define{morphism of root systems}\index{morphism!of root systems} \((E, R, \innerprod{-}{-}) \to (E', R', \innerprod{-}{-}')\) consists of a linear map \(f \colon E \to E'\) which restricts to a function \(f|_R \colon R \to R'\) (that is, \(f(R) \subseteq R'\)) and preserves the inner product on \(R\), so that for all \(\alpha, \beta \in R\) we have
        \begin{equation}
    ...
    \begin{dfn}{Weyl Group}{}
        The \defineindex{Weyl group}, \(W\), of a root system, \((E, R, \innerprod{-}{-})\), is the group generated by the set of all reflections
        \begin{equation}
    ...
    \begin{exm}{}{}
        ...
        \begin{enumerate}
            ...
            \begin{align}
                ...
                &= e_k - e_{\ell} - (\delta_{ki} - \delta_{kj} - \delta_{\ell i} + \delta_{\ell j})(e_i - e_j).
            \end{align}
            We now have to consider cases.
            If \(\{i, j\} \cap \{k, \ell\} = \emptyset\) then
            \begin{equation}
                s_{e_i - e_j}(e_k -e_{\ell}) = e_k - e_{\ell} \in R.
            \end{equation}
            If \(i = k\) but \(j \ne \ell\) then
            \begin{equation}
                s_{e_i - e_j}(e_k - e_{\ell}) = e_i - e_{\ell} - (e_i - e_j) = e_j - e_{\ell} \in R.
            \end{equation}
            Similar results hold if \(i = \ell\) and \(j \ne k\), or if \(j = k\) and \(i \ne \ell\) or \(j = \ell\) and \(i \ne k\).
            Finally, if \(i = k\) and \(j = \ell\) we have
            \begin{equation}
                s_{e_i - e_j}(e_k - e_{\ell}) = e_i - e_j - 2(e_i - e_j) = e_j - e_i \in R
            \end{equation}
            and a similar result if \(i = \ell\) and \(j = k\).
            This shows that \(s_{e_i - e_j}\) maps \(R\) into itself.
            \item Finally, we have already shown in the above computation that
            \begin{equation}
                2\frac{\innerprod{e_k - e_{\ell}}{e_i - e_j}}{\innerprod{e_i - e_j}{e_i - e_j}} = \delta_{ki} - \delta_{kj} - \delta_{\ell i} + \delta_{\ell j} \in \integers.
            \end{equation}
        \end{enumerate}
    ...
    \begin{dfn}{Simple Roots}{}
        ...
        A set of \define{simple roots}\index{simple root} is a subset \(\Delta \subseteq R\) such that
        \begin{enumerate}
    ...
    \begin{dfn}{Cartan Matrix}{}
        ...
        The corresponding \defineindex{Cartan matrix} is the \(\ell \times \ell\) integer matrix where the entry on row \(i\) and column \(j\) is
        \begin{equation}
    ...
    \begin{dfn}{Dynkin Diagram}{}
        ...
        The \defineindex{Dynkin diagram} corresponding to this data is the \(n\)-vertex directed graph whose vertices are labelled by the roots simple \(\alpha_i\), with edges between distinct vertices given as follows:
        \begin{itemize}
