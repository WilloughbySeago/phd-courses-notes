...
\begin{document}
    ...
    Instead, we may consider a special conformal transformation \(z \mapsto z' = z/(cz + 1)\), will allow us to determine \(C_{12}\).
    We have
    \begin{equation}
    ...
    \begin{multline}
        \correlator{\quantumField{O}_{h_1,\overbar{h}_1}(z_1, \overbar{z}_1) \quantumField{O}_{h_2,\overbar{h}_2}(z_2, \overbar{z}_2)} =\\
        \left( \frac{1}{cz_1 + 1} \right)^{h_1} \left( \frac{1}{cz_2 + 1} \right)^{h_2} \left( \frac{1}{\overbar{c}\overbar{z}_1 + 1} \right)^{\overbar{h}_1} \left( \frac{1}{\overbar{c}\overbar{z}_2 + 1} \right)^{\overbar{h}_2}\\
        \times \correlator{\quantumField{O}_{h_1,\overbar{h}_1}(z_1', \overbar{z}_1') \quantumField{O}_{h_2, \overbar{h}_2}(z_2', \overbar{z}_2')}.
    \end{multline}
    Equating this with \cref{eqn:2pt correlator translated and rotated} we must have
    \begin{multline}
        \left( \frac{1}{z_2 - z_1} \right)^{h_2} \left( \frac{1}{\overbar{z}_2 - \overbar{z}_1} \right)^{\overbar{h}_2} C_{12} = \left( \frac{1}{cz_1 + 1} \right)^{h_1} \left( \frac{1}{cz_2 + 1} \right)^{h_2} \left( \frac{1}{\overbar{c}\overbar{z}_1 + 1} \right)^{\overbar{h}_1}\\
        \times \left( \frac{1}{\overbar{c}\overbar{z}_2 + 1} \right)^{\overbar{h}_2} \correlator{\quantumField{O}_{h_1,\overbar{h}_1}(z_1', \overbar{z}_1') \quantumField{O}_{h_2, \overbar{h}_2}(z_2', \overbar{z}_2')}.
    \end{multline}
    Rearranging this and using \cref{eqn:z2' - z1'} for \(C_{12} \ne 0\) we get
    \begin{equation}
