...
\begin{document}
    ...
    \begin{exm}{}{}
        ...
        \begin{equation}
            \phi_a(x) \mapsto \phi_a(x) + \omega^b \varepsilon_{abc} \phi_c(x)
        \end{equation}
        where \(\varepsilon_{abc}\) is the Levi-Civita totally antisymmetric 3-nr defined by \(\varepsilon_{123} = 1\).
        This comes from the fact that \(\varepsilon_{abc}\) are the structure constants of the \(\orthogonalLie(3)\) Lie algebra, which consists of antisymmetric \(3 \times 3\) real matrices.
