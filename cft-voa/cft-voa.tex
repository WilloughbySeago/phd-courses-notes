...
\begin{document}
    ...
    \begin{equation}
        \correlator{\quantumField{O}_{h_1, \overbar{h}_1'}(z_1, \overbar{z}_1) \quantumField{O}_{h_2, \overbar{h}_2}(z_2, \overbar{z}_2)} = \left( \frac{1}{z_2 - z_1} \right)^{h_1 + h_2} \left( \frac{1}{\overbar{z}_2 - \overbar{z}_1} \right)^{\overbar{h}_1 + \overbar{h}_2} \correlator{\quantumField{O}_{h_1, \overbar{h}_1}(0, 0) \quantumField{O}_{h_2, \overbar{h}_2}(1, 1)}.
    \end{equation}
    ...
    A final transformation, this time a special conformal transformation \(z'' \mapsto z''' = z''/(cz'' + 1)\), will allow us to determine \(C_{12}\).
    We have
    \begin{equation}
